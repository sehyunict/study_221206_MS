			...
			<tbody id="musicList">
				<c:forEach items="${adminMusicList}" var="e">
					<tr>
						...
						<th>${e.music_like}</th>
						<th><form:form action="/adMusicInfo" modelAttribute="vo">
	...
	<ul class="pagination">
		<c:if test="${pageMaker.prev}">
			<li class="page-item"><a class="page-link"
				href="/adminMusic${pageMaker.makeQuery(pageMaker.startPage - 1)}">이전</a></li>
		</c:if>
			...
			<c:choose>
				<c:when test="${nowpage == i}">
					<li class="page-item"><a class="page-link"
						...
						href="/adminMusic${pageMaker.makeQuery(i)}">${i}</a></li>
				</c:when>
				<c:otherwise>
					<li class="page-item"><a class="page-link"
						href="/adminMusic${pageMaker.makeQuery(i)}">${i}</a></li>
		...
		<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
			<li class="page-item"><a class="page-link"
				href="/adminMusic${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li>
		</c:if>
